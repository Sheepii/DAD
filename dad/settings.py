...
SECRET_KEY = os.environ.get(
    "SECRET_KEY",
    "django-insecure-n#kc(uz$yahr!c-c)=8(kn#8vug4loxas7ts*%svl7**m2o(mk",
)
...
MIDDLEWARE = [
    ...
    'handoff.middleware.ProxyHeaderLoggingMiddleware',
...
GOOGLE_DRIVE_CREDENTIALS_FILE = BASE_DIR / os.environ.get(
    "GOOGLE_DRIVE_CREDENTIALS_FILE", "credentials.json"
)
GOOGLE_DRIVE_TOKEN_FILE = BASE_DIR / os.environ.get(
    "GOOGLE_DRIVE_TOKEN_FILE", "token.json"
)
GOOGLE_DRIVE_USE_SERVICE_ACCOUNT = (
    os.environ.get("GOOGLE_DRIVE_USE_SERVICE_ACCOUNT", "").lower() == "true"
)
GOOGLE_DRIVE_SERVICE_ACCOUNT_FILE = BASE_DIR / os.environ.get(
